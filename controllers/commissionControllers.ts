...
export async function createCommission(name:string, email:string, cellPhone:string,aproxSesions: number, value: number, userId:string){
  ...
  const validationData = commissionSchemaValidation.safeParse({ name, email, cellPhone, aproxSesions,value, userId })
